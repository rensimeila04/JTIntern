                ...
                <div class="w-80 flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex gap-1">
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Sen
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Sel
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Rab
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Kam
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Jum
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Sab
                            </div>
                            <div class="w-10 h-10 flex justify-center items-center text-xs font-medium text-gray-500">Min
                            </div>
                        </div>
                        <!-- Calendar Days -->
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                        <table class="min-w-full divide-y-2 divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 w-fit">
                                        Hari, Tanggal
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 w-48">
                                        Waktu
                                    </th>
                                    <th scope="col"
                                    ...
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 w-44">
                                        Status Feedback
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 w-48">
                                        Aksi
