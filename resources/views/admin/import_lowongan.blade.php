...
@section('content')
    <div class="p-6 space-y-6 bg-white rounded-lg">
        <div class="flex justify-between items-center">
            <h1 class="text-xl font-medium text-neutral-900">Import Lowongan</h1>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="font-medium text-blue-800 mb-1">Panduan Import Lowongan</h3>
                    <ul class="list-disc ml-5 text-sm text-blue-700 space-y-1">
                        ...
                        <li>Isi data lowongan sesuai format yang telah disediakan</li>
                        <li>Kolom <strong>id_perusahaan_mitra</strong>, <strong>id_periode_magang</strong>, <strong>judul_lowongan</strong>, <strong>deskripsi</strong>, <strong>persyaratan</strong>, <strong>id_kompetensi</strong>, dan <strong>jenis_magang</strong> wajib diisi</li>
                        <li>jenis_magang harus diisi dengan: wfo, remote, atau hybrid</li>
                        <li>Format tanggal deadline pendaftaran: YYYY-MM-DD (contoh: 2024-12-31)</li>
                        <li>kolom test diisi dengan 1 (ya) atau 0 (tidak)</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <h3 class="mb-2 text-lg font-medium text-gray-900">Import Data Lowongan</h3>
            <p class="mb-6 text-sm text-gray-600 text-center max-w-md">
                Unduh template Excel terlebih dahulu, isi data lowongan, kemudian unggah file Excel yang telah diisi.
            </p>

            <div class="flex flex-col sm:flex-row gap-3 w-full max-w-md justify-center">
                <a href="{{ route('admin.lowongan.template') }}" class="btn-secondary flex items-center justify-center">
        ...
        <div
            ...
            <div class="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm pointer-events-auto">
                ...
                <div class="p-4 overflow-y-auto">
                    <form id="uploadForm" action="{{ route('admin.lowongan.import.store') }}" method="POST"
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                Pilih file (.xlsx, .xls, atau .csv) yang berisi data lowongan yang ingin diimport.
                            </p>
                        </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4 text-xs text-yellow-800">
                            ...
                            <ul class="list-disc ml-5 mt-1">
                                ...
                                <li>Baris pertama adalah header (id_perusahaan_mitra, id_periode_magang, judul_lowongan, dll)</li>
                            </ul>
                        </div>
            ...
            <div class="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm pointer-events-auto">
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            <span id="successCount" class="font-semibold">0</span> data lowongan berhasil diimport ke dalam
                            sistem.
                        </p>
                        <div class="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                            <div class="flex items-center">
                                ...
                                <p class="text-xs text-green-800">
                                    Data lowongan telah ditambahkan ke dalam sistem dan siap untuk digunakan.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="text-center">
                        ...
                        <p id="errorMessage" class="text-sm text-gray-600 mb-2">
                            Terjadi kesalahan saat mengimport data lowongan.
                        </p>
