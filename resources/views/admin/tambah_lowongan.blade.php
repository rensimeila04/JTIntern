                ...
                <div class="space-y-4 w-full">
                    ...
                    <div class="flex flex-row gap-4 items-center">
                        ...
                        <label for="test" class="relative inline-block w-11 h-6 cursor-pointer">
                            ...
                            <span class="absolute inset-0 bg-gray-200 rounded-full transition-colors duration-200 ease-in-out peer-checked:bg-primary-500"></span>
                            <span class="absolute top-1/2 start-0.5 -translate-y-1/2 size-5 bg-white rounded-full transition-transform duration-200 ease-in-out peer-checked:translate-x-full"></span>
                        </label>
                    </div>
                    <div class="w-full">
