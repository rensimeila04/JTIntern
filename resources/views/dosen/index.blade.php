...
<head>
    ...
    <title>Dosen Dashboard - JTIntern</title>
            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <div class="px-4 py-6 sm:px-0">
                    <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 p-4 bg-white">
                        <h2 class="text-2xl font-semibold mb-4">Welcome, Dosen!</h2>
                        <p class="text-gray-600">This is your dosen dashboard. You can manage your students, view reports, and more.</p>
                    </div>
                </div>
            </div>
        </main>
